var years = ['1781','1850','1881_1','1881_2','1896','1910',/*'1911',
            ...
            '1944','1946'/*,'1955'*/,'1957'/*,'1958','1960','1962'*/,'1965_1','1973',
...
(function() {
	...
	for(var i=1;i<=years.length;i++){
	    if(i == years.length || $('#'+years[i]).offset()['top']-1 >= $(window).scrollTop()){
		      $('ul.timeline li:nth-child('+(i)+') .leftlabel').css('background-color','#ffe301');
            if(i>years.length){
              eventOffset=$('ul.timeline li:nth-child('+(i)+')').position()['top']-$(window).height()/1.5;
            }
		        else if(i > 3)
